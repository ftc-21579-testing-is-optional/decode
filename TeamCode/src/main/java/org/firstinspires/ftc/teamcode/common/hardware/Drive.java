...
public class Drive {
    ...
    public void init() {
        ...
        backLeftDrive = this.bot.hardwareMap.get(DcMotor.class, "motor1");
        frontRightDrive = this.bot.hardwareMap.get(DcMotor.class, "motor2");
        backRightDrive = this.bot.hardwareMap.get(DcMotor.class, "motor3");
