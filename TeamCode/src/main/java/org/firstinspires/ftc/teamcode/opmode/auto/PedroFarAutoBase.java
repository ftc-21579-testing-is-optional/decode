...
import org.firstinspires.ftc.teamcode.opmode.auto.paths.FarPathsBase;
...
//@Configurable // Panels
public class PedroFarAutoBase extends OpMode {
    private TelemetryManager panelsTelemetry; // Panels Telemetry instance
    public Follower follower; // Pedro Pathing follower instance
    private int pathState; // Current autonomous path state (state machine)
    protected FarPathsBase paths; // Paths defined in the Paths class
